...
public class ConsultaCnpjDto implements Serializable {
    ...
    private String dataSituacao_especial;
    ...
    public String getDataSituacao_especial() {
        return dataSituacao_especial;
    }

    public void setDataSituacao_especial(String dataSituacao_especial) {
        this.dataSituacao_especial = dataSituacao_especial;
    }
