...
public class JWTTokenAutenticacaoService {
    ...
    private static final Instant EXPIRATION_TIME = LocalDateTime.now().plusDays(11).toInstant(ZoneOffset.of("-03:00"));
    ...
    public Authentication getAuthentication(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            response.getWriter().write("Token está invalido ou expirado");
        } catch (ExpiredJwtException e){
            response.getWriter().write("Token está inspirado efetue o login novamente");
        }
        finally {
            liberacaoCors(response);
