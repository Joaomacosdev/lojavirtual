...
public class Produto implements Serializable {
	...
	public @NotNull(message = "A categoria deve ser informado") CategoriaProduto getCategoriaProduto() {
		return categoriaProduto;
	}

	public void setCategoriaProduto(@NotNull(message = "A categoria deve ser informado") CategoriaProduto categoriaProduto) {
